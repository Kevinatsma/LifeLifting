...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'clients/:id', component: ClientDetailComponent, data: {state: 'client-detail'}, canActivate: [AuthGuard]},
      ...
      {path: 'my-clients/:id', component: MyClientDetailComponent, data: {state: 'my-clients-detail'}, canActivate: [AuthGuard]},
      ...
      {path: 'foods/:id', component: FoodDetailComponent, data: {state: 'food-detail'}, canActivate: [AuthGuard]},
      {path: 'exercises', component: ExercisesComponent, data: {state: 'exercises'}, canActivate: [AuthGuard]},
      {path: 'exercises/:id', component: ExerciseDetailComponent, data: {state: 'exercise-detail'}, canActivate: [AuthGuard]},
    ]
  },
];
